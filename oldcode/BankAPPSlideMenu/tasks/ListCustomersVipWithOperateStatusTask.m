//
//  ListCustomersVipWithOperateStatusTask.m
//  BankAPP
//
...
@implementation ListCustomersVipWithOperateStatusTask
@synthesize request;
...
- (void)process {
    @try {
        NSString *url = [[App sharedInstance].cfg urllistCustomersVipWithOperateStatus];
