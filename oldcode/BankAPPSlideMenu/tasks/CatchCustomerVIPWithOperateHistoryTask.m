//
//  CatchCustomerVIPWithOperateHistoryTask.m
//  BankAPP
//
...
@implementation CatchCustomerVIPWithOperateHistoryTask
@synthesize request;
...
- (void)process {
    @try {
        NSString *url = [[App sharedInstance].cfg urlcatchCustomerVIPWithOperateHistory];
