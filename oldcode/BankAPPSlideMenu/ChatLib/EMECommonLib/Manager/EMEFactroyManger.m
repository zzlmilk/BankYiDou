...

{
    if ([ObjectClass isKindOfClass:[UILabel class]]) {
        return  [self.class createUILableWithContent:nil
                                               Frame:CGRectZero];
...
/*!
 ...
 @result   新创建的UIlabel
 */
+(UILabel *)createUILableWithContent:(NSString *)newContent
...
/*!
 ...
 @result   新创建的UIlabel
 */
+(EMEVerticalLabel *)createEMEVerticalLabelWithContent:(NSString *)newContent
                               Frame:(CGRect)newFrame
{
    
    EMEVerticalLabel*   newLable =[[EMEVerticalLabel alloc] init];
    if (newContent !=nil) {
        newLable.text = newContent;
    }
    
    newLable.frame = (!CGRectIsEmpty(newFrame)) ? newFrame : UILabelDefaultFrame;
    
    newLable.font = UIFontFromString(@"size14");
    
    newLable.backgroundColor = UILabelDefaultBackgroundColor ;
    
    newLable.textAlignment = NSTextAlignmentLeft;
    
    newLable.textColor = UILabelDefaultTextColor;
                                        ...
                                        Delegete:(id)newDelete
{
    ...
    newField.textColor = UIColorFromString(@"font_color05");
                              ...
                              ButtonTag:(NSInteger)newButtonTag
{
    ...
    //Button 默认的背景
    //    [newButton.btn setBackgroundImage:[[UIImage imageNamed:@"g_button_bg01.png"] stretchableImageWithLeftCapWidth:10 topCapHeight:0]
    //                                    forState:UIControlStateNormal];
    //
    //    [newButton.btn setBackgroundImage:[[UIImage imageNamed:@"g_button_bg02.png"] stretchableImageWithLeftCapWidth:10 topCapHeight:0]
