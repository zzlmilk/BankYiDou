...
//#define ResouceCoreDataModeName @"EMEApp"


static NSString *DefaultResourceCoreDataModeName = @"EMEApp";
static NSString *DefaultSQLiteFileName = @"EMEApp.sqlite3";
...
{
    return [self QueryObjectsWithTable:table_name condition:condition sortByKey:key limit:1 ascending:NO];
