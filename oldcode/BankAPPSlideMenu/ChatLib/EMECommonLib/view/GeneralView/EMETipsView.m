 ...
 */
    ...
    if (tipsIconImageName) {
        self.tipsIconImageView.image = [UIImage imageNamed:tipsIconImageName];
    }
    ...
    switch (tipsPositionType) {  //jy06_gou
        ...
        case TipsVerticalPostionForCenter:
        {
            ...
            //背景
            self.tipsBackgroundImageView.image = [CommonUtils ImageWithImageName:@"hd_02_layer_bg" EdgeInsets:UIEdgeInsetsMake(10, 0, 20, 0)];
        ...
        case TipsVerticalPostionForBottom: //只有这个的frame 和背景需要改变
        {
            ...
            //背景
            self.tipsBackgroundImageView.image = [CommonUtils ImageWithImageName:@"jy05_tip_bg" EdgeInsets:UIEdgeInsetsMake(10, 0, 20, 0)];
