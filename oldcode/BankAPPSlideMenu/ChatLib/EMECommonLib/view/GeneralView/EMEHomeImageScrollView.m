...
#import "EMEHomeImageScrollView.h"
#import "Utility.h"

@interface EMEHomeImageScrollView ()
{
    int selIndex;
}
...
@implementation EMEHomeImageScrollView
...
//        }
        ...
        _theGridView.frame=CGRectMake(0, 0, 320.0f, 190.0f);
        CGFloat y=_pageControl.frame.origin.y+30;
        setOriginY(_theGridView, y);
